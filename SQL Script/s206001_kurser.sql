...
CREATE TABLE `kurser` (
  ...
  `ECTSpoint` float NOT NULL,
  `skema` varchar(45) NOT NULL,
  `kursusAnsvarlig` varchar(45) NOT NULL,
...
INSERT INTO `kurser` VALUES (1,'Humanbiologi',17008890,10,'Tirsdag','Mikkel','Universitetsparken','Farmaceutisk'),(2,'Systemudvikling',13220020,10,'Onsdag','Anders','Universitetsparken','Biovidenskabelig');
